...
def start(message):
    ...
    bot.send_message(message.chat.id, "እንኳን ወደ KENO ROYAL በሰላም መጡ!", reply_markup=markup)

# "Launch" ሲጫኑ ቀጥታ ወደ Keno.html ይወስዳቸዋል
...
def launch_game(message):
    ...
    # ሊንኩ በትክክል ወደ Keno.html ተቀይሯል
    play_button = types.InlineKeyboardButton(text="አሁኑኑ ተጫወት 🎮", url="https://daniel-zt06.onrender.com/Keno.html")
    markup.add(play_button)
    
    bot.send_message(message.chat.id, "የኬኖ ጨዋታ ለመጀመር ከታች ያለውን ሊንክ ይጫኑ፦", reply_markup=markup)
